...
export function StepSwitcherClient({
    ...
    return (
        <section>
            <h2 className="text-calc-xl font-bold text-enbek_primary">
                {content[locale]?.title}
            </h2>
            <section className="flex flex-col mt-5">
                <section className={
                    clsx(
                        "flex gap-4 bg-enbek_primary px-5 rounded-xl max-md:flex-col max-md:px-0 overflow-hidden",
                    )
                }>
                        ...
                        return (
                            <button
                                className={clsx(
                                    ...
                                    activeStep === content.link ? " border-white max-md:bg-enbek_primary_active" : ""
                                )}
