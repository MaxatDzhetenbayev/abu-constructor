...
import { fetchCreateAdminNavigation } from "@/features/navigation/admin-navigation/api/fetch-create";
...
export const TemplateSection = ({ content_id }: { content_id: number }) => {
  ...
  const handleCreateNavigation = async () => {
    const sendData: Pick<INavigation, "slug" | "title" | "navigation_type" | "parent_id"> = {
      title: {
        ru: " ",
        kz: " ",
        en: " ",
      },
      navigation_type: NavigationEnum.DETAIL,
