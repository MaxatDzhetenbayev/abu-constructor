...
export const AdminSidebar = async ({
  ...
  return (
    <nav
      className={clsx(
        className,
        "flex z-10 items-center md:items-start md:static flex-row md:flex-col fixed left-0 right-0 h-20 justify-center md:justify-between gap-3 bg-abu_primary text-white p-10 md:h-full"
      )}
      {...props}
    >
      <ChangeLocale />
