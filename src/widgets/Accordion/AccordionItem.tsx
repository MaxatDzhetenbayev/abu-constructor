...
import { AccordionItemProps } from './model/Accordion.interface';
import { animateOptions } from './model/Accordion.consts';


export const AccardionItem = ({ title, content }: AccordionItemProps): ReactNode => {
