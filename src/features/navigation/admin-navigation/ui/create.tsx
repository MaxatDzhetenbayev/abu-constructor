...
export const AdminNavigationCreate = ({ parent_id = null }: AdminNavigationCreateProps): React.JSX.Element => {
    const [pageType, setPageType] = useState<NavigationEnum>(NavigationEnum.CONTENT);
    ...
    const { mutate, isPending } = useAdminCreateNavigation(closeRef, reset, queryClient);
