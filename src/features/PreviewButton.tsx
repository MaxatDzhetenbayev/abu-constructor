...
const mockProps = {
  ...
  Accordion: {
    options:
      '{"title":"Вопросы и ответы по приему на высшее образование","items":[{"title":"Вопросы и ответы по приему на высшее образование","content":"Для поступления в Alikhan  Bokeikhan  University на программы высшего образования, абитуриентам необходимо сдать Единое национальное тестирование (ЕНТ), кроме иностранных граждан и выпускников колледжей, поступающие на родственные специальности по сокращенной программе обучения на платной основе.","href":"","templateId":"145*146","templateSlug":"/template-1722939061317"}],"language_key":"ru","navigation_id":2}',
  },
  List: {
    options:
