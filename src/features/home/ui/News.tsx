    ...
    return (
        <Link href={`news/${id}`}>
            ...
            >
                ...
                <div className="">
                    <h2 className="text-enbek_primary font-semibold text-calc-xl">{head}</h2>
...
const MoreButton = ({
    ...
    return (
        <Link
            href={`${link}`}
            className="flex py-3 w-full justify-center items-center rounded-lg bg-enbek_primary gap-2"
            style={{
                maxWidth,
            }}
        >
